            ...
            <div class="flex flex-wrap -m-4">
                <div class="p-4 md:w-1/3">
                    <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                        <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="assets/img/login/login-2.png" alt="blog" style="width:100%; height: auto;">
                        <div class="p-6">
                ...
                <div class="p-4 md:w-1/3 bg-gray-200" style="font-family: 'Andada Pro', serif;  border-radius: 15px 50px;" >
                    <ol list-style:upper-roman>
                        ...
                        <br>
                        <li> It is one of the most favorite destination for
                            Corporate house as they are aware of the fact that NITJ is known to introduce bright, vibrant and effervescent
                            youngminds to the industry</li>
                        <br>
                        ...
                        <br>
                        <li style="text-align:right">- Head, Centre of Training & Placement</li>

                    </ol>
                </div>
                <div class="p-4 md:w-1/3 ">
                    <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                        <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="assets/img/login/login-1.webp" alt="blog" style="width:100%; height: auto;">
