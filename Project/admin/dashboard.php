              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="info-box bg-c-yellow">
                    <a href="companies.php"><span class="info-box-icon bg-red"><i class="ion ion-briefcase"></i></span></a>
                ...
                <div class="col-md-6">
                  <div class="info-box bg-c-yellow">
                    <a href="applications.php"><span class="info-box-icon bg-green"><i class="ion ion-person-stalker"></i></span></a>
                    <div class="info-box-content">
