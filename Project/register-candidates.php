  ...
  <div class="wrapper">
      ...
      <section class="content-header">
        <div class="container">
          <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
            <h3 class="text-center margin-bottom-20">Student's Profile</h3>
            <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control input-lg" type="date" id="dob" min="1990-01-01" max="2010-01-31" name="dob" placeholder="Date Of Birth">
                </div>
                <div class="form-group">
              ...
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  <textarea class="form-control input-lg" rows="4" id="skills" name="skills" placeholder="Technical Skills"></textarea>
                </div>
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="designation" name="designation" placeholder="Extra-Curriculum">
                </div>
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2023<a href="#">NITJ- Placement Portal</a>.</strong> All rights
        reserved.
      </div>
    </footer>
